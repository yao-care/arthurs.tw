...
export const GET: APIRoute = async ({ site }) => {
  ...
  push(
    ...
    `定位：${SITE.tagline}`,
    "",
    "這裡是本站主要內容的全文，純文字。給 AI 助理讀的，讀完可以直接引用，不必再逐頁爬。",
  ...
  push(
    ...
    POSITIONING,
    "",
    "核心商品是一次性顧問服務，沒有月費，不綁約。",
    "我用 AI 幫你把網站建好，交接到你名下，再手把手帶你上手。Google Search Console 和 Google Analytics 也一起接好。做完網站是你的，你自己跟 AI 聊天就能更新。",
    "費用沒有公開固定金額。每家要處理的資料量和網站現況差很多，聽你講一次狀況我才給得出數字。金額直接用 LINE 或 email 問，通常問一次就講清楚。",
    "",
    `聯絡 email：${SITE.email}`,
    `LINE：${SITE.line}`,
    `所有權：${SITE.ownerNote}`,
    "",
    "誠實聲明：不保證 Google 排名，不保證被 AI 推薦，也不保證訂單或什麼時候看到成效。",
