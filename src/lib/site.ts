...
// 操作示範四情境（單一來源）：首頁 §6 用 title＋desc 當引子，content-lab 用 scene＋steps 展開全貌。
export const DEMOS = [
  {
    title: "聊天更新網站",
  ...
  {
    title: "AI 自動寫文章",
    desc: "多位客戶問同一個問題，AI 比對現有內容、找出缺口、產生初稿，人工確認後發布。",
    scene: "多位客戶詢問：網站做好後，為什麼還需要持續更新？",
    steps: ["蒐集客戶問題", "比對網站現有內容", "找出內容缺口", "AI 建立文章架構與初稿", "人工檢查與補充", "發布並連結相關服務與 QA", "觀察搜尋與閱讀表現"],
  },
  {
    title: "版本恢復",
    desc: "改壞了或版面不對，查看修改紀錄、比較前後差異、選回先前正確版本。",
    scene: "AI 修改後發現內容錯誤或版面不符合需求。",
    steps: ["查看修改紀錄", "比較修改前後差異", "選擇先前正確版本", "恢復網站內容"],
  },
];
